...
class CartController extends Controller
{
    ...
    public function countAction($id)
    {
        ...
        $query = $em->createQuery('SELECT p as product, COUNT(i.id) as qty, (COUNT(i.id)*p.weight) as weight FROM BiocareProductBundle:CartItem i JOIN BiocareProductBundle:Product p WHERE i.storage = :cart GROUP BY p.id');
