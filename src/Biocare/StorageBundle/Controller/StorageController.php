...
class StorageController extends Controller
{
    ...
    public function expoAction($id)
    {
        ...
        $query = $em->createQuery('SELECT p as product,DISTINCT(i.product), COUNT(i.id) as qty FROM BiocareProductBundle:Item i JOIN BiocareProductBundle:Product p WHERE i.storage = :storage GROUP BY i.product');
