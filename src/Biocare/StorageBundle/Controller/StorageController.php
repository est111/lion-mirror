...
class StorageController extends Controller
{
    ...
    public function expoAction($id)
    {
        ...
        $query = $em->createQuery('SELECT distinct(p),p as product, COUNT(i.id) as qty FROM BiocareProductBundle:Item i JOIN BiocareProductBundle:Product p WHERE i.storage = :storage GROUP BY i.product');
