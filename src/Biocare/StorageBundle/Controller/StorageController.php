...
class StorageController extends Controller
{
    ...
    public function expoAction($id)
    {
        ...
        $query = $em->createQuery('SELECT p as product, COUNT(i.id) as qty FROM BiocareProductBundle:Item i JOIN BiocareProductBundle:Product p ON p.id = i.product_id WHERE i.storage_id = :storage GROUP BY p.id');
