...
class StorageController extends Controller
{
    ...
    public function expoAction($id)
    {
        ...
        $query = $em->createQuery('SELECT (SELECT p FROM BiocareProductBundle:Product p WHERE product=p.id), distinct(i.product) as product, COUNT(i.id) as qty FROM BiocareProductBundle:Item i WHERE i.storage = :storage GROUP BY i.product');
