...
use Biocare\ProductBundle\Entity\Product;
use Biocare\ProductBundle\Form\ProductType;
...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BiocareProductBundle:Product')->findAll();
     ...
     * @Method("POST")
     * @Template("BiocareProductBundle:Product:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BiocareProductBundle:Product')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BiocareProductBundle:Product:edit.html.twig")
     */
