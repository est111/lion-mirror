...
use Biocare\ProductBundle\Entity\Item;
use Biocare\ProductBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BiocareProductBundle:Item')->findAll();
     ...
     * @Method("POST")
     * @Template("BiocareProductBundle:Item:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BiocareProductBundle:Item')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BiocareProductBundle:Item:edit.html.twig")
     */
